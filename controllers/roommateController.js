...
const scoreProfile = (viewerProfile, candidateProfile) => {
  ...
  [
    ["sleepSchedule", "Similar sleep schedule", 15],
    ["cleanliness", "Similar cleanliness preference", 15],
    ["noisePreference", "Similar noise preference", 10],
    ["guestPreference", "Similar guest preference", 10],
    ["studyPreference", "Similar study style", 10],
